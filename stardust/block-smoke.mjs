...
const CASES = {
  ...
  'band|band split mist': row('<h2>Seamlessly connect your payment provider</h2>') + row('<p>A long enough beat lede paragraph for the text-only split band here.</p>') + row('<p>A second sentence that continues the beat description faithfully.</p>'),
  'band|band accent cta': row('<h2>Grow your subscription business faster</h2>') + row('<p>A long enough closing lede paragraph for the accent CTA band here.</p>') + row('<p><strong><a href="/s">Get started</a></strong> <em><a href="/d">Book a Q&A session</a></em></p>'),
  ...
  'band|band stats': row('<h2>Improve your Trial experience</h2>') + row('<p>A long enough beat lede paragraph for the trial-insights stat band here.</p>') + row('Conversion rate', '8.5%') + row('Average Trial Length', '13d') + row('Active Trials', '225') + row('Cancelled Trials', '47') + row('<p><strong><a href="/s">Get started</a></strong></p>'),
  'band|band mist stats': row('<h2>See how you really stack up</h2>') + row('<p>A long enough beat lede paragraph for the benchmark stat band here.</p>') + row('MRR Growth Rate', '0.92%') + row('Benchmark', '0.85%') + row('Revenue Churn Rate', '6.42%') + row('Benchmark', '5.22%') + row('<p><strong><a href="/s">Get started</a></strong></p>'),
  ...
  'logos|logos strip': row('<p>Trusted by growing SaaS Companies</p>') + row(IMG + IMG + IMG),
  ...
  'feature-hero|feature-hero recover': row('<h1>Deeper SaaS insights in one place, in real-time.</h1>') + row('<p>A long enough hero lede paragraph that reads as a lede for the masthead.</p>') + row('<p><strong><a href="/s">Get started</a></strong> <em><a href="/d">Contact Sales</a></em></p>') + row('14 Days Free. No Credit Card Required.'),
  'feature-hero|feature-hero recover exhibit': row('<h1>Deeper SaaS insights in one place, in real-time.</h1>') + row('<p>A long enough hero lede paragraph that reads as a lede for the masthead.</p>') + row('<p><strong><a href="/s">Get started</a></strong> <em><a href="/d">Contact Sales</a></em></p>') + row('14 Days Free. No Credit Card Required.') + row('<img src="https://baremetrics.com/hubfs/x.png" width="760" height="570" alt="">'),
  'feature-hero|feature-hero case mirror mist': row('<h2>See how you really stack up</h2><p>A supporting lede that is long enough to read as one here for the beat.</p>') + row('<p><strong><a href="/s">Get started</a></strong></p>'),
